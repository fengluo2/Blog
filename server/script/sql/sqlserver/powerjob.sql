...
VALUES (N'1', N'ruoyi-worker', N'192.168.31.100:10010', N'2023-06-13 16:32:59.2630000', N'2023-07-04 17:25:49.7980000', N'123456')
    GO
...
(
    ...
    [alarm_config] varchar
(
    255
) NULL,
    [app_id] bigint NULL,
    [concurrency] int NULL,
    [designated_workers] varchar
(
    255
) NULL,
...
(
    ...
    [notify_user_ids] varchar
(
    255
) NULL,
    [processor_info] varchar
(
    255
) NULL,
...
INSERT INTO [pj_job_info] ([id], [alarm_config], [app_id], [concurrency], [designated_workers], [dispatch_strategy], [
...
-- ----------------------------
CREATE
NONCLUSTERED INDEX [idx01_container_info]
...
-- ----------------------------
CREATE
NONCLUSTERED INDEX [idx01_instance_info]
ON [pj_instance_info] (
  [job_id] ASC,
  [status] ASC
)
...
CREATE
NONCLUSTERED INDEX [idx02_instance_info]
ON [pj_instance_info] (
  [app_id] ASC,
  [status] ASC
)
...
CREATE
NONCLUSTERED INDEX [idx03_instance_info]
ON [pj_instance_info] (
  [instance_id] ASC,
  [status] ASC
)
...
-- ----------------------------
CREATE
NONCLUSTERED INDEX [idx01_job_info]
ON [pj_job_info] (
  [app_id] ASC,
  [status] ASC,
...
-- ----------------------------
CREATE
NONCLUSTERED INDEX [idx01_server_info]
ON [pj_server_info] (
  [gmt_modified] ASC
)
GO
...
-- ----------------------------
CREATE
NONCLUSTERED INDEX [uidx01_user_info]
ON [pj_user_info] (
  [username] ASC
)
GO
...
CREATE
NONCLUSTERED INDEX [uidx02_user_info]
ON [pj_user_info] (
  [email] ASC
)
GO
...
-- ----------------------------
CREATE
NONCLUSTERED INDEX [idx01_workflow_info]
ON [pj_workflow_info] (
  [app_id] ASC,
  [status] ASC,
  [time_expression_type] ASC,
...
-- ----------------------------
CREATE
NONCLUSTERED INDEX [idx01_wf_instance]
...
-- ----------------------------
CREATE
NONCLUSTERED INDEX [idx01_workflow_node_info]
